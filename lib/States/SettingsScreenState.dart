...
class SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _controllerDate = new TextEditingController(
        text: DateHelper.convertDateToString(DateTime.now()));
    _controllerTimeStart = new TextEditingController(
        text: DateHelper.convertTimeToString(DateTime.now()));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Settings'),
        //WorktagLocalizations.of(context).screen_edit),
        actions: <Widget>[
          IconButton(
                ...
                children: <Widget>[
                  new Row(children: <Widget>[
                    new Expanded(
                      ...
                      //onSaved: (val) => widget.timeEntry.date = DateHelper.parseDate(val),
                    )),
                    new IconButton(
  ...
  void _submitForm() {
    ...
    if (!form.validate()) {
      showMessage('Form is not valid!  Please review and correct.',
          Theme.of(form.context).errorColor);
    } else {
      form.save(); //This invokes each onSaved event
      showMessage('Saving Settings...', Theme.of(form.context).accentColor);
